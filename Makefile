...
pkgdatadir = $(datadir)/siag
pkglibdir = $(libdir)/siag
pkgincludedir = $(includedir)/siag

top_builddir = .

ACLOCAL = /home/sameklu/Downloads/siag-3.6.1/missing aclocal-1.4
AUTOCONF = /home/sameklu/Downloads/siag-3.6.1/missing autoconf
AUTOMAKE = /home/sameklu/Downloads/siag-3.6.1/missing automake-1.4
AUTOHEADER = /home/sameklu/Downloads/siag-3.6.1/missing autoheader
...
LTLIB = @LTLIB@
MAKEINFO = makeinfo
MY_X_LIBS = -lMowitz -lneXtaw -lXpm -lXmu -lXext
NDBM = 
PACKAGE = siag
PERL = 
PERLINC = 
...
SUBDIRS =  	cole 	stocks 	siod 	common 	xcommon 	siag 	xsiag 	tsiag 	pw 	xpw 	egon 	xegon 	plugins 	xed 	xfiler 	o3read 	gvu


DIST_SUBDIRS = $(SUBDIRS)

INCLUDES = $(DEBUG)  -DXAWHDRS=@XAWHDRS@
